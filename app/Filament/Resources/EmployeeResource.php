    ...
    public static function form(Form $form): Form
    {
        return $form
            ->schema([
                ...
                ->schema([
                    // first name
                    TextInput::make('first_name')->minLength(2)->maxLength(25)->required(),
                    // last name
                    TextInput::make('last_name')->minLength(2)->maxLength(25),
                    // address
                    TextInput::make('address')->minLength(2)->maxLength(100),
                    // select country
                    Select::make('country_id')->label('Country Name')
                    ->options(Country::all()->pluck('name', 'id')->toArray())->reactive()->required(),
                    // select state
                    ...
                    // select city
                    Select::make('city_id')->label('Select City')->relationship('city', 'name')->required(),
                    // select department
                    Select::make('department_id')->label('Department Name')->relationship('department', 'name')->required(),
                    // zip code
